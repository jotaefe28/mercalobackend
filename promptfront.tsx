// Frontend Prompt - Ver FRONTEND_PROMPT.md para el prompt completo
export {};
...
interface DashboardRequirements {
  // Sidebar
  sidebar: {
    company_logo: "imagen o iniciales de la empresa"
    company_name: "nombre de la empresa del contexto"
    user_info: "avatar, nombre, rol"
    navigation: [
      "Dashboard", "Ventas", "Productos", "Clientes", 
      "Inventario", "Reportes", "Configuración"
    ]
    collapse_toggle: "hamburger menu responsive"
  }
  ...
  header: {
    ...
    notifications: "campana con badge"
    profile_menu: "dropdown con logout"
  }
  
  // Main Content
  content: {
    responsive_grid: "adaptable a todas las pantallas"
    loading_states: "skeletons mientras carga data"
    empty_states: "placeholders cuando no hay data"
  }
}
```
...
interface TestRequirements {
  ...
  e2e_tests: [
    ...
    "Error scenarios: wrong credentials, network failure",
...
### Paleta de Colores MercaloPOS:
- **Primario**: `bg-blue-600` (botones principales)
- **Secundario**: `bg-gray-100` (backgrounds)
- **Éxito**: `bg-green-500` (confirmaciones)
- **Error**: `bg-red-500` (errores y alertas)
- **Warning**: `bg-yellow-500` (advertencias)

### Componentes UI Específicos:
- **Botones**: Estados loading, disabled, hover con transiciones
- **Inputs**: Focus states, error states, icons integrados
- **Cards**: Shadows sutiles, rounded corners, hover effects
- **Modals**: Backdrop blur, center positioning, close animations
...
#### **4. Configuración de Seguridad Frontend**
